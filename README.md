...
- Consumer install and lifecycle commands: `docs/consumer-install.md`
- Vault semantic index and authoring rules: `docs/vault.md`
- Claude end-to-end test evidence model: `docs/claude-e2e-contract.md`
...
Vault context is optional and lives under `vault/`. Agents may author or update it, while the runtime only reads it and never depends on it for correctness.

See `docs/vault.md` for the vault directory layout, authoring rules, semantic index lifecycle, query filters, and testing strategy.
...
Claude end-to-end coverage is documented in `docs/claude-e2e-contract.md`.
...
Consumer-project installation, lifecycle commands, config, and generated layout guidance live in `docs/consumer-install.md`.
